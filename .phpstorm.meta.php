    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Laravel\Passkeys\Contracts\PasskeyLoginResponse' => \App\Http\Responses\PasskeyLoginResponse::class,
    ...
    override(\config(), map([
            ...
            'clamav.preferred_socket' => 'string',
            'clamav.unix_socket' => 'string',
            'clamav.tcp_socket' => 'string',
            'clamav.socket_connect_timeout' => 'NULL',
            'clamav.socket_read_timeout' => 'integer',
            'clamav.client_exceptions' => 'boolean',
            'clamav.skip_validation' => 'boolean',
            ...
            'ide-helper.tenant_ignored_models' => 'array',
            ...
            'permission.roles.platform.admin' => 'string',
            'permission.roles.platform.billing' => 'string',
            'permission.roles.platform.support' => 'string',
            'permission.roles.landlord.admin' => 'string',
            'permission.roles.landlord.billing' => 'string',
            'permission.roles.landlord.portfolio_manager' => 'string',
            'permission.roles.landlord.maintenance' => 'string',
            'permission.roles.landlord.user' => 'string',
            'permission.roles.contractor.admin' => 'string',
            'permission.roles.contractor.contractor' => 'string',
            'permission.roles.tenant.tenant' => 'string',
            ...
            'ziggy.output.path' => 'string',
            'ziggy.output.routes' => 'string',
            'ziggy.output.typescript' => 'string',
...
'cache.prefix','cache.serializable_classes','clamav.preferred_socket','clamav.unix_socket','clamav.tcp_socket',
'clamav.socket_connect_timeout','clamav.socket_read_timeout','clamav.client_exceptions','clamav.skip_validation','database.default',
...
'ide-helper.include_factory_builders','ide-helper.tenant_ignored_models','ide-helper.macroable_traits','inertia.ssr.enabled','inertia.ssr.url',
...
'media-library.force_lazy_loading','passkeys.relying_party_id','passkeys.allowed_origins','passkeys.user_handle_secret','passkeys.timeout',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.roles.platform.admin','permission.roles.platform.billing',
'permission.roles.platform.support','permission.roles.landlord.admin','permission.roles.landlord.billing','permission.roles.landlord.portfolio_manager','permission.roles.landlord.maintenance',
'permission.roles.landlord.user','permission.roles.contractor.admin','permission.roles.contractor.contractor','permission.roles.tenant.tenant','queue.default',
...
'ziggy.output.path','ziggy.output.routes','ziggy.output.typescript','boost.enabled','boost.browser_logs_watcher',
...
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','sanctum.stateful','sanctum.guard',
...
'query-builder.disable_invalid_include_query_exception','query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','tinker.commands',
...
'passkey.store','passkey.destroy','horizon.stats.index','horizon.workload.index','horizon.masters.index',
...
'horizon.failed-jobs.show','horizon.retry-jobs.show','horizon.jobs.show','horizon.index','sanctum.csrf-cookie','home','dashboard','invitations.accept',
'profile.edit','profile.update','profile.destroy','security.edit','user-password.update',
'appearance.edit','teams.index','teams.store','teams.edit','teams.update',
'teams.destroy','teams.switch','teams.members.update','teams.members.destroy','teams.invitations.store',
'teams.invitations.destroy','storage.local','storage.local.upload',);
...
'APP_URL','APP_SERVICE','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE',
...
'QUEUE_CONNECTION','CACHE_STORE','REVERB_APP_ID','REVERB_APP_KEY','REVERB_APP_SECRET',
...
'VITE_APP_NAME','VITE_REVERB_APP_KEY','VITE_REVERB_AUTH_URL','VITE_REVERB_HOST','VITE_REVERB_PORT',
'VITE_REVERB_SCHEME','WWWGROUP','WWWUSER',);
